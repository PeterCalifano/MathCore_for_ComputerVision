...
function(handle_compiler_flags)
    ...
    set(_minsizerel_flags -Os -DNDEBUG -fmax-errors=1)
...
function(handle_compiler_flags_interface)
    ...
    elseif(NOT (CMAKE_BUILD_TYPE_LOWER MATCHES "release" OR
                CMAKE_BUILD_TYPE_LOWER MATCHES "relwithdebinfo" OR
                CMAKE_BUILD_TYPE_LOWER MATCHES "minsizerel"))
...
function(print_compiler_flags_summary)
    ...
    elseif(CMAKE_BUILD_TYPE_LOWER MATCHES "minsizerel" AND NOT NO_OPTIMIZATION)
